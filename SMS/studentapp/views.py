...
def view_marks(request):
    ...
    try:
        ...
        marks = Marks.objects.filter(student=student)  # Use filter instead of get
        return render(request, "studentapp/view_marks.html", {'marks': marks})
    except (StudentList.DoesNotExist, User.DoesNotExist):
        return render(request, "studentapp/view_marks.html", {'error': 'Student not found.'})
    except Marks.DoesNotExist:
        return render(request, "studentapp/view_marks.html", {'error': 'Marks not found.'})
